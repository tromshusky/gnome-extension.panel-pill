...
import { PANEL_HEIGHT, PANEL_OPACITY_HIGH, PANEL_OPACITY_LOW, PANEL_OPACITY_MAX, PANEL_XY_RATIO, PANEL_Y, STILL_ON_SCREEN_PIXEL } from "./extension.js";
...
export default class PanelUI {
    ...
    moveUpDown(translationY, duration, callback) {
    ...
    moveLeftRight(relative_x, duration, callback) {
        Main.layoutManager.panelBox.ease({
            // somehow the library in use doesnt support translation_x and translation_y
            // @ts-expect-error 
    ...
    #getPillTranslationBasedOnMouse() {
    ...
    setPillXAkaLeftRight(basedOnMouse) {
